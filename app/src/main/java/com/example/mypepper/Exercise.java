            ...
            for (int count1 = 0; count1 < array.length; count1++) {
                ...
                switch (array[count1]) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Log.i(TAG, "executed > start boxing ");
                    ...
                    case 9:
                        ...
                        PepperSay.doSay(qiContext,"\\rspd=80\\ jetzt versucht eure Arme so weit es geht in die Höhe zustrecken\\pau=200\\"+
                                "\\rspd=80\\beim runterkommen versuchen wir mit den Händen die Füße zu berühren");
                        waitForSay();
                    ...
                    case 10:
                        ...
                        waitForSay();
                        PepperSay.doSay(qiContext,"\\rspd=80\\ wir öffnen unsrere Fäuste und schließen sie mit aller Kraft \\pau=200\\"+
